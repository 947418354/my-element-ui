    ...
    methods: {
      ...
      renderPostfix(h) {
        ...
        if (node.loading) {
          ...
          if(isChecked){
            return this.renderLeafCheckedIcon(h);
          }else{
            return this.renderLeafIcon(h);
          }
        }
      ...
      renderLeafIcon(h) {
        return (
          <i class="my-cascader-node__postfix"></i>
        );
      },
      //被选中的叶子图标后缀
      renderLeafCheckedIcon(h) {
        return (
          <i class="my-cascader-node-checked__postfix"></i>
        );
      },
      renderContent(h) {
